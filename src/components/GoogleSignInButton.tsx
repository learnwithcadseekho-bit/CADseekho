...
export function GoogleSignInButton() {
  ...
  async function handleClick() {
    ...
    try {
      ...
      setError("Google sign-in isn't available right now. Please try email/password instead.");
      setLoading(false);
    }
  }
  ...
  return (
    <div>
      ...
      <button type="button" className="btn btn--outline btn--block google-btn" onClick={handleClick} disabled={loading}>
        <GoogleIcon />
